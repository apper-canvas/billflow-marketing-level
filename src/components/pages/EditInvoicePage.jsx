...
export default function EditInvoicePage() {
  ...
  async function loadData() {
    try {
      setLoading(true);
      setError(null);
      const [invoice, clientsList] = await Promise.all([
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      await invoicesService.update(id, invoiceData);
      ...
      <Container>
        <div className="bg-white rounded-2xl shadow-xl p-6 lg:p-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900">Edit Invoice</h1>
